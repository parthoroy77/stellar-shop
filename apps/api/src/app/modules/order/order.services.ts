...
/**
 * Get Seller Subsequent orders
 */
const getSellerOrders = async ({ status }: TSellerOrderFilters, options: TPaginateOption, userId: number) => {
...
export const OrderServices = { place, getSellerOrders };
