...
const EmptyCheckout = () => {
  return (
    <div className="flex h-[450px] flex-col items-center justify-center gap-2 py-4">
      <svg
        width="271px"
        height="166px"
        id="Layer_1"
      ...
      <div className="flex flex-col items-center justify-center space-y-3">
        <p className="text-accent-foreground mx-auto w-[60%] text-center text-base">
          Oops! Checkout is unavailable at the moment. Please continue shopping and add items to your cart before
