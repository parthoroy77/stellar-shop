import { Badge, Popover, PopoverContent, PopoverTrigger } from "@ui/index";
  ...
  return (
    <Popover>
      <PopoverTrigger>
        <button
          type="button"
          className="hover:bg-accent/40 relative flex size-9 items-center justify-center rounded-full duration-300"
        >
